...
namespace CMRenderer::CMDirectX
{
	...
	inline constexpr UINT CM_CONSTANT_BUFFER_REGISTER_SLOT_INVALID = UINT_MAX;
...
#pragma region Buffers
	...
	public:
		[[nodiscard]] HRESULT Create(Components::DXDevice& deviceRef) noexcept;
	...
	public:
		...
		void BindVS(Components::DXDevice& deviceRef, UINT offset = 0u) noexcept;
		void BindPS(Components::DXDevice& deviceRef, UINT offset = 0u) noexcept;
	...
	/* Wraps a buffer type, and stores it's data locally to ensure lifetime errors don't occur. */
