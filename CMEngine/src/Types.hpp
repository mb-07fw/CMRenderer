...
namespace CMEngine
{
	...
	inline CM_ENGINE_API [[nodiscard]] bool IsNearEqualFloat(float x, float other, float epsilon = G_NEAR_EQUAL_FLOAT_EPSILON) noexcept
	{
	...
	struct CM_ENGINE_API Float3 : public Float2
	{
