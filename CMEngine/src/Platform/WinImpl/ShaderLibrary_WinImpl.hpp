...
namespace CMEngine::Platform::WinImpl
{
	...
	enum CM_ENGINE_API ShaderType : int8_t
	{
	...
	enum CM_ENGINE_API AssignedShaderType : int8_t
	{
	...
	enum CM_ENGINE_API ShaderSetType : int8_t
	{
...
#pragma region Shader Sets
	...
	enum CM_ENGINE_API ShaderUseType : ShaderUseID
	{
